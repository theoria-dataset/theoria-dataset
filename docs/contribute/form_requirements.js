...
const FIELD_REQUIREMENTS = {
  ...
  "properties": {
    ...
    "derivation": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "description": {
            "type": "string",
            "description": "Textual description for this derivation step. Define new symbols that appear. Provide concise and clear rationale, and minimize the formulas, as they should go in the equation field. If there are math symbols or equations included, they must be enclosed in backticks (``) and written in AsciiMath format."
          },
          "equation": {
            "type": "string"
          },
    ...
    "theory_status": {
      ...
      "description": "Current scientific status of the theory. current: Modern theories widely accepted by scientific community. historical: Important for development but generalized by more comprehensive theories. approximation: Valid simplifications of more general theories. limiting_case: Special cases with restricted applicability. generalized: Subsumed into a more general framework but remains valid in its regime."
    },
    "generalized_by": {
      "type": "array",
      "description": "Theories that generalize or supersede this result. Use exact result_id values (without .json extension). Must reference existing entries in the dataset.",
      "items": {
        "type": "string",
        "pattern": "^[a-z0-9_]+$"
      }
